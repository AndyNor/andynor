...
urlpatterns = [
	...
	re_path(r'^account/(?P<account>\d{1,5})/transactions/$', views.account_transactions_api, name="money_account_transactions"),
	re_path(r'^account/(?P<account>\d{1,5})/$', views.account, name="money_account"),
